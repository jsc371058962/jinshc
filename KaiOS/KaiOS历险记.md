...
2. 今天分配了`contact` bug需要改(1.23)，是一个值得纪念的日子
3. 公司24号年会了，很幸运的中了个三等奖哈哈，也是终结了我中奖绝缘体的`debuff`.

# 改bugs 第九周(20190128)

1. `/system/bin/sh: kill: 2855: Operation not permitted`解决办法:
...
3. 上午写周报，都快尴尬死，前一个多月实际上做的事情很少，突然格式化了一部分，弄的有些东西都不知道怎么谢了，总不能千篇一律，都在熟悉代码吧，哎难受O(∩_∩)O哈哈~

4. <span style="color:red; font-weight:blood;">失之毫厘差之千里</span>

5. 2.28碰见一个比较一般的git问题，在多分支下本地git库与远程保持一致，有时会出现有人提交代码，有新的历史记录，此时本地master分支和xx分支需要与远程的分支保持一致，并在此基础上进行更改，否则会不能push代码。砥砺前行啊。。。

6. 桥归桥路归路

7. 开始`DOM`看一遍再手动敲一遍

8. 如果止步不前会被淘汰，如果明日复明日会被淘汰，如果抱有侥幸心理会被淘汰，总而言之言而总之，如果你懒惰会被淘汰。

# 春节 第十周(20190204)

1. 春节快乐！

# Gaia/建筑提案 第十一周(20190212)

1. 开工大吉！发了100的红包哦
2. 再看了脉脉上各种职场大佬的吹b之后，我燃起了强烈的斗志啊
3. 这几天都在弄**Gaia/建筑提案**，其实原理还有很多不清楚的，这个东西不是很好弄，是一种新型的解决性能问题的使用多线程的一种方案，再理解理解

# 暂定 第十二周(20190218)

1. 觉得时间在急速的浪费掉，在我看OWL的时候，心思放的不对，这样是不合理的状态，当身心都不在轨道，飘荡在外的时候躯体就是一个空壳，这样使得自身没有汲取到任何养分，会枯死掉的我确信，但是我有点深陷其中不能自拔。。。谁能救救我。。。
2. 状态真的非常不好，一直感觉眼睛很重，是因为没睡好的原因吗？
3. 
